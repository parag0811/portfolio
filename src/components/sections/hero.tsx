        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <a
                href="https://x.com/ParagRangankar"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-11 w-11 items-center justify-center rounded-full border-2 border-foreground bg-card transition-all duration-300 ease-[var(--ease-bounce)] hover:-translate-y-0.5 hover:bg-black hover:text-white hover:border-black hover:shadow-[var(--shadow-pop)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring/40"
          ...
          <motion.div 
            ...
            className="relative h-80 sm:h-[28rem] lg:h-[32rem]"
          >
